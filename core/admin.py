...
from .models import Course, Lecture, Handout, VideoLecture, LabWork, CourseHistory
...
class CourseAdmin(admin.ModelAdmin):
    ...
    def add_materials(self, obj):
        add_lecture = reverse('admin:core_lecture_add') + f'?course={obj.id}'
        add_handout = reverse('admin:core_handout_add') + f'?course={obj.id}'
        add_video = reverse('admin:core_videolecture_add') + f'?course={obj.id}'
        add_lab = reverse('admin:core_labwork_add') + f'?course={obj.id}'
...
# Remove the CourseHistoryAdmin registration - the inline will still work
